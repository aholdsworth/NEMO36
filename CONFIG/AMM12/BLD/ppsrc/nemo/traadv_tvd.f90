         ...
         DO jk = 1, jpkm1
            ...
            DO jj = 2, jpjm1
               DO ji = 2, jpim1   ! vector opt.
                  ...
                  pta(ji,jj,jk,jn) =                       pta(ji,jj,jk,jn) +         ztra   / e3t_0(ji,jj,jk) * tmask(ji,jj,jk)
                  zwi(ji,jj,jk)    = ( e3t_0(ji,jj,jk) * ptb(ji,jj,jk,jn) + z2dtt * ztra ) / e3t_0(ji,jj,jk) * tmask(ji,jj,jk)
               END DO
            END DO
         END DO
