            ...
            DO jk = 1, jpkm1
               DO jj = 1, jpjm1
                  DO ji = 1, jpi
                     ...
                     zah   = rldf * ahtu(ji,jj,jk) * r_fact_lap(ji,jj,jk)                                  ! fsaht(ji+ip,jj,jk)
            ...
            DO jk = 1, jpkm1
               DO jj = 1, jpjm1
                  DO ji=1,jpi
                     ...
                     zah   = rldf * ahtv(ji,jj,jk)                                  ! fsaht(ji,jj+jp,jk)
                  ...
                  DO kp = 0, 1
                     DO jj = 1, jpjm1
                        DO ji = 1, jpi
                           ...
                           zah = rldf * ahtu(ji,jj,jk) * r_fact_lap(ji,jj,jk)   !*umask(ji,jj,jk+kp)         !fsaht(ji+ip,jj,jk)           ===>>  ????
                  ...
                  DO kp = 0, 1
                     DO jj = 1, jpjm1
                        DO ji = 1, jpi
                           ...
                           zbv = 0.25_wp * e1v(ji,jj) * e2v(ji,jj) * e3v_n(ji,jj,jk)
                           ! ln_botmix_grif is .T. don't mask zah for bottom half cells
                           zah = rldf * ahtv(ji,jj,jk)        !*vmask(ji,jj,jk+kp)  ! fsaht(ji,jj+jp,jk)
                           zah_slp = zah * zslope_iso
                           zaei_slp = aeiv0 * zslope_skew        ! fsaeit(ji,jj+jp,jk)*zslope_skew
